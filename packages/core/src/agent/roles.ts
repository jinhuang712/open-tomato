...
2. 立项信息缺失就先补：一句话故事是硬门，没有它不排大纲、不写正文，派 planner / writer 会被拒；其余各项聊到哪算哪，书名可以先「待定」。**拿到答案立刻 write_doc / edit_doc 写进 守则/立项 对应段落，写完这一项才问下一项**，不要问完两三项攒着最后一起写——你这一轮随时可能被打断，没落盘的答案就白问了
